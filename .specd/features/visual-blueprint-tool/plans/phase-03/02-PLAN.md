...
depends_on:
  - phase-02/01-PLAN.md
creates:
  - specdacular/workflows/blueprint-diagrams.md
modifies: []
---

# Plan 02: Create Diagrams Extension Workflow

## Objective

Create the workflow that generates Mermaid diagrams (flow diagrams and ER diagrams) for a feature and integrates them into the blueprint.
...
- `@.specd/features/visual-blueprint-tool/RESEARCH.md` — Mermaid.js integration approach

**Relevant Decisions:**
- DEC-003: Mermaid.js for diagrams — CDN script, pinned version, `securityLevel: 'loose'`
- DEC-006: High-level happy-path diagrams — Help user understand feature flow

**From Research:**
- Mermaid CDN: `https://cdn.jsdelivr.net/npm/mermaid@10.6.1/dist/mermaid.min.js`
- Use `securityLevel: 'loose'` for file:// protocol
- Generate flowcharts for process flow, ER diagrams for data relationships
- Keep diagrams high-level and focused on happy path

---

## Tasks

### Task 1: Create Diagrams Workflow File

**Files:** `specdacular/workflows/blueprint-diagrams.md`

**Action:**
Create the workflow file that generates Mermaid diagrams based on feature artifacts.
...
**Verify:**
```bash
[ -f "specdacular/workflows/blueprint-diagrams.md" ] && grep -q "generate_flow_diagram" specdacular/workflows/blueprint-diagrams.md && echo "valid"
```

**Done when:**
- [ ] File exists at `specdacular/workflows/blueprint-diagrams.md`
- [ ] Has all required steps
- [ ] Documents both flow and ER diagram generation
- [ ] Includes Mermaid.js integration
...
[ -f "specdacular/workflows/blueprint-diagrams.md" ] && echo "workflow exists"

# Check has required steps
grep -q "generate_flow_diagram" specdacular/workflows/blueprint-diagrams.md && echo "has flow diagram"
grep -q "generate_er_diagram" specdacular/workflows/blueprint-diagrams.md && echo "has er diagram"
grep -q "mermaid" specdacular/workflows/blueprint-diagrams.md && echo "has mermaid"
```

**Plan is complete when:**
- [ ] Workflow file exists
- [ ] All steps documented
- [ ] Mermaid integration included
...
2. Commit changes:
   ```bash
   git add specdacular/workflows/blueprint-diagrams.md
   git commit -m "feat(blueprint): add diagrams workflow

   Plan 3.02 complete:
   - Workflow for generating Mermaid diagrams
   - Flow diagram for process visualization
   - ER diagram for data relationships
   - Updates blueprint with diagrams tab"
   ```

3. Feature implementation complete! All phases done.
